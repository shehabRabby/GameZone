...
const GameDetails = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto my-10 bg-white rounded-xl shadow-lg overflow-hidden">
      ...
      <img src={game.coverPhoto} alt={game.title} className="w-full h-74 object-cover" />
      <div className="p-6 space-y-4">
        <h1 className="text-2xl font-bold">{game.title}</h1>
        <p className="text-gray-600"><span className='font-extrabold'>Developer:</span> {game.developer}</p>
        <p className="text-gray-600"><span className='font-extrabold'>Category:</span> {game.category}</p>
