...
const ReactMotion = () => {
  ...
  return (
    <div className="relative w-full min-h-screen  flex flex-col justify-center items-center  overflow-hidden">
      <div className="relative w-2/3 h-[400px] overflow-hidden rounded-3xl shadow-2xl">
        ...
        <div className="absolute bottom-6 right-6 flex items-center justify-center">
          <animated.svg
            ...
            viewBox="0 0 60 60"
            style={springs}
            className="stroke-[#58a6ff] fill-none stroke-[4px]"
          >
      ...
      <p className="text-black text-lg mt-4 max-w-2xl text-center leading-relaxed">
        At <span className="text-[#58a6ff] font-semibold">GameZone</span>, we
        blend creativity and technology to bring you stunning generative visuals
        and the ultimate gaming experience. Dive into art, motion, and fun!
      </p>
    </div>
  );
};
